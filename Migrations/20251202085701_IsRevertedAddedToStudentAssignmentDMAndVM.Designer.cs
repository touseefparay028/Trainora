...
namespace LearningManagementSystem.Migrations
{
    ...
    [Migration("20251202085701_IsRevertedAddedToStudentAssignmentDMAndVM")]
    partial class IsRevertedAddedToStudentAssignmentDMAndVM
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.DTO.AccountDeletionReason", b =>
                {
                    b.Property<Guid>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.ClassSessions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.CourseMaterial", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.QuestionDM", b =>
                {
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.StudentAnswer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.StudentTestResult", b =>
                {
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.TestAttemptDM", b =>
                {
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.TestDM", b =>
                {
                    b.Property<Guid>("TestId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TeacherAssignmentDM", b =>
                {
                    b.HasOne("LearningManagementSystem.Models.Domains.BatchDM", "BatchDM")
                        .WithMany("TeacherAssignments")
                        .HasForeignKey("BatchDMId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BatchDM");
                });

            modelBuilder.Entity("LearningManagementSystem.Models.Domains.TestDM.QuestionDM", b =>
                {
                    b.HasOne("LearningManagementSystem.Models.Domains.TestDM.TestDM", "Test")
                        .WithMany("Questions")
            ...
            modelBuilder.Entity("LearningManagementSystem.Models.IdentityEntities.ApplicationUser", b =>
                {
                    b.HasOne("LearningManagementSystem.Models.Domains.CourseMaterial", null)
